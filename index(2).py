...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.left_button_1 = QtWidgets.QPushButton(qtawesome.icon('fa.music', color='white'), "1")
        self.left_button_1.setObjectName('left_button')
        self.left_button_2 = QtWidgets.QPushButton(qtawesome.icon('fa.sellsy', color='white'), "2")
        self.left_button_2.setObjectName('left_button')
        self.left_button_3 = QtWidgets.QPushButton(qtawesome.icon('fa.film', color='white'), "3")
        self.left_button_3.setObjectName('left_button')
        self.left_button_4 = QtWidgets.QPushButton(qtawesome.icon('fa.home', color='white'), "1")
        self.left_button_4.setObjectName('left_button')
        self.left_button_5 = QtWidgets.QPushButton(qtawesome.icon('fa.download', color='white'), "2")
        self.left_button_5.setObjectName('left_button')
        self.left_button_6 = QtWidgets.QPushButton(qtawesome.icon('fa.heart', color='white'), "3")
...
#使用qtawesome这个第三方库来实现按钮中的Font Awesome字体图标的显示。然后将创建的按钮添加到左侧部件的网格布局层中：
    ...
    def show_img(self):
        ...
        # self.pilImage = Image.open("Figure_1.png")
        # self.tkImage = ImageTk.PhotoImage(image=self.pilImage)
        # self.label = tk.Label(self, image=self.tkImage)
        # self.label.pack()

            # img_png = Tkinter.PhotoImage(file='Figure_1.png')
